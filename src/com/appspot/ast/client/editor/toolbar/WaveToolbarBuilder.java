 ...
 * Time: 8:16 PM
 */
public class WaveToolbarBuilder extends Composite implements ToolbarBuilder {
  interface Binder extends UiBinder<Widget, WaveToolbarBuilder> { Binder BINDER = GWT.create(Binder.class); }
  private ButtonUpdater updater;
  private EditorContextAdapter editorContextAdapter;

  public WaveToolbarBuilder() {
    ...
    new ToolbarButtonViewBuilder()
        ...
        .applyTo(toolbar.addClickButton(), new ToolbarClickButton.Listener() {
          @Override public void onClicked() {
            Range range = editorContextAdapter.getSelectionHelper().getOrderedSelectionRange();
            if (range == null) {
              Window.alert("Select place in text to insert an image.");
              return;
            }
            final CMutableDocument document = editorContextAdapter.getDocument();
  ...
  private ToolbarToggleButton.Listener createTextSelectionController(ToolbarToggleButton b,
    ...
    return updater.add(new TextSelectionController(b, editorContextAdapter,
  ...
  private void createClearFormattingButton(ToolbarView toolbar) {
    new ToolbarButtonViewBuilder()
        ...
        .applyTo(toolbar.addClickButton(), new ToolbarClickButton.Listener() {
          @Override public void onClicked() {
            EditorAnnotationUtil.clearAnnotationsOverSelection(editorContextAdapter, asArray(
  ...
  private void createInsertLinkButton(ToolbarView toolbar) {
    ...
    new ToolbarButtonViewBuilder()
        ...
        .applyTo(toolbar.addClickButton(), new ToolbarClickButton.Listener() {
              @Override  public void onClicked() {
                FocusedRange range = editorContextAdapter.getSelectionHelper().getSelectionRange();
                ...
                try {
                  ...
                  EditorAnnotationUtil.setAnnotationOverSelection(editorContextAdapter, Link.MANUAL_KEY,
                      linkAnnotationValue);
  ...
  private void createRemoveLinkButton(ToolbarView toolbar) {
    new ToolbarButtonViewBuilder()
        ...
        .applyTo(toolbar.addClickButton(), new ToolbarClickButton.Listener() {
          @Override public void onClicked() {
            if (editorContextAdapter.getSelectionHelper().getSelectionRange() != null) {
              EditorAnnotationUtil.clearAnnotationsOverSelection(editorContextAdapter, Link.LINK_KEYS);
            }
          }
        });
  }
  ...
  private ToolbarClickButton.Listener createClearHeadingsListener() {
    return new ParagraphTraversalController(editorContextAdapter, new ContentElement.Action() {
  ...
  private void createIndentButton(ToolbarView toolbar) {
    ...
    new ToolbarButtonViewBuilder()
        .setIcon(css.indent())
        .applyTo(b, new ParagraphTraversalController(editorContextAdapter, Paragraph.INDENTER));
  }
  ...
  private void createOutdentButton(ToolbarView toolbar) {
    ...
    new ToolbarButtonViewBuilder()
        .setIcon(css.outdent())
        .applyTo(b, new ParagraphTraversalController(editorContextAdapter, Paragraph.OUTDENTER));
  }
  ...
  private ToolbarToggleButton.Listener createParagraphApplicationController(ToolbarToggleButton b,
    ...
    return updater.add(new ParagraphApplicationController(b, editorContextAdapter, style));
  }
